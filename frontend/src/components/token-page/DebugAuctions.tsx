...
export function DebugAuctions() {
  ...
  const { allAuctions, auctionsInSelectedCollection, nftContract } =
    ...
    <Box p={4} bg="black" color="white" mt={8} borderRadius="md">
      ...
      {isOpen && (
        <Box>
          ...
          <Text fontWeight="bold" mt={4}>
            All Auctions ({allAuctions?.length || 0}):
          </Text>
          <Code
            p={2}
            borderRadius="md"
          ...
          <Text fontWeight="bold" mt={4}>
            Filtered Auctions for this Collection (
            {auctionsInSelectedCollection?.length || 0}):
          </Text>
          <Code
            p={2}
            borderRadius="md"
